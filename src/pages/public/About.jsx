    ...
    <div className="nb-about-page">
      <div className="nb-about-container">
        ...
        <div className="nb-about-header">
          <h1 className="nb-about-title nb-bilingual-headline">About AI Restaurant</h1>
        ...
        <div className="nb-callout-card mb-12">
          <p className="nb-callout-text">
            We built AI Restaurant after watching restaurant teams battle jammed ticket printers, clunky legacy terminals, and split-bill chaos during Saturday night rushes. This is why it exists.
          </p>
        </div>
        ...
        <div className="nb-about-sections">
          ...
          <div className="nb-about-section-item">
            <div className="nb-section-badge-header">
              ...
              <h2 className="nb-about-section-title">Why we built AI Restaurant</h2>
            </div>
          ...
          <div className="nb-about-section-item">
            <div className="nb-section-badge-header">
              ...
              <h2 className="nb-about-section-title">What AI Restaurant is</h2>
            </div>
            <div className="nb-about-section-body">
              <p>
                AI Restaurant is a <strong>unified restaurant operating platform</strong>. Guests scan table QR codes to browse and order in seconds. Orders route instantly to digital kitchen displays, and bills settle directly from phones.
              </p>
              <p>
        ...
        <div className="nb-about-cta-card mt-16">
          <div className="nb-cta-inner">
            <ServoraLogo size={48} />
            <div>
              <h3 className="nb-h3 mb-1">Try AI Restaurant on your floor</h3>
